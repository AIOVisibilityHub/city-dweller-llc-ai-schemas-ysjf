...
WEBSITE = _client.get('canonicalUrl') or manifest.get('canonicalUrl', '') or manifest.get('websiteUrl', 'https://citydweller.aiovisibility.net')
...
PAGES_URL = (_client.get('pagesUrl') or manifest.get('pagesUrl') or 'https://citydweller.aiovisibility.net/') or (WEBSITE or '')
